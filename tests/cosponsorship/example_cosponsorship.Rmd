...
**K1=3,K2=4**
```{r,eval=FALSE,echo=FALSE,warning=FALSE,message=FALSE}
formula.monad1 = ~ seniority + ideol1 + ideol2 + party + sex
formula.monad2 = ~ Major2 + billsponsor_seniority + billsponsor_ideol1 + 
...
co.model2 <- mmsbm(formula.dyad = Y ~ reciprocity_prop0 + lreciprocity_prop,
                    ...
                    n.blocks = c(n.blocks1,n.blocks2),
                    n.hmmstates = 1,
                    mmsbm.control = list(seed=12345,
                                         hessian = TRUE,
                                         verbose=TRUE,
                                         vi_iter = 1,
                                         conv_tol = 1e-6
