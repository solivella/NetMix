...
, where $\theta_{pqt, z_{pqt}, u_{qpt}} = \mathrm{logit}^{-1} (B_{z_{pqt},u_{pqt}} + \mathbf{d}_{pq}^\top \boldsymbol{\gamma})$ is the probability of a tie formation between $p$ in family 1 and $q$ in family 2 at time $t$ 
